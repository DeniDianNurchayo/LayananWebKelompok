	...
	<h1>U'note</h1>
		<div class="registration">
			<h2>Registration Form</h2>				
					<form>
						<div class="form-info">
						<input type="text" class="text" value="Your Full Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Your Name';}" >
						<input type="text" class="text" value="Email Adress" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email Adress';}" >
...
<div class="copy-rights">
					<p>Design by <a href="http://w3layouts.com" target="_blank">RPM_DE</a> </p>
			</div>
